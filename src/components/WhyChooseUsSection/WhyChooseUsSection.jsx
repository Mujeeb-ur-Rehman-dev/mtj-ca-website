...
const WhyChooseUsSection = () => {
  ...
  const cardsData = [
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width="44" height="44">
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="44" height="44">
    ...
    <section className="different-section">
      <div className="different-container">
        ...
        <div className="different-grid">
          {cardsData.map((card) => (
            <div key={card.id} className="stamp-card-container">
